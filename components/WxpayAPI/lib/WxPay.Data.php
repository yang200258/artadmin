...
class WxPayResults extends WxPayDataBase
{
     ...
     * @throws WxPayException
     */
    public static function InitPayment($xml)
    {
        $obj = new self();
        $obj->FromXml($xml);
        //fix bug 2015-06-29
 ...
 *
 */
class WxPayPayment extends WxPayDataBase
{
    /**
     * 设置微信分配的公众账号ID
     * @param string $value
    ...
    /**
     * 获取NO_CHECK：不校验真实姓名 FORCE_CHECK：强校验真实姓名
     * @return 值
     **/
    ...
    /**
     * 判断NO_CHECK：不校验真实姓名 FORCE_CHECK：强校验真实姓名
     * @return true 或 false
     **/
